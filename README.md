...
[![PWC](https://img.shields.io/endpoint.svg?url=https://algoagents.com/badge/axcell-automatic-extraction-of-results-from/scientific-results-extraction-on-pwc)](https://algoagents.com/sota/scientific-results-extraction-on-pwc?p=axcell-automatic-extraction-of-results-from)
[![PWC](https://img.shields.io/endpoint.svg?url=https://algoagents.com/badge/axcell-automatic-extraction-of-results-from/scientific-results-extraction-on-nlp-tdms-exp)](https://algoagents.com/sota/scientific-results-extraction-on-nlp-tdms-exp?p=axcell-automatic-extraction-of-results-from)
...
* [ArxivPapers](https://github.com/algoagents/axcell/releases/download/v1.0/arxiv-papers.csv.xz)
* [SegmentedTables & LinkedResults](https://github.com/algoagents/axcell/releases/download/v1.0/segmented-tables.json.xz)
* [PWCLeaderboards](https://github.com/algoagents/axcell/releases/download/v1.0/pwc-leaderboards.json.xz)
...
- [axcell](https://github.com/algoagents/axcell/releases/download/v1.0/models.tar.xz) &mdash; an archive containing the taxonomy, abbreviations, table type classifier and table segmentation model. See the [results-extraction](notebooks/results-extraction.ipynb) notebook for an example of how to load and run the models 
- [language model](https://github.com/algoagents/axcell/releases/download/v1.0/lm.pth.xz) &mdash; [ULMFiT](https://arxiv.org/abs/1801.06146) language model pretrained on the ArxivPapers dataset
...
| ---------- |---------------- | -------------- |
| [PWC Leaderboards](https://algoagents.com/sota/scientific-results-extraction-on-pwc)     |     21.1         |      28.7       |
| [NLP-TDMS](https://algoagents.com/sota/scientific-results-extraction-on-nlp-tdms-exp)    |     19.7         |      25.8       |
